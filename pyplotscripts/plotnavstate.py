...
filepath = '/home/mc/SLAM/ORB_MC_VI/tmp/';
filename = filepath+'KeyFrameNavStateTrajectory.txt';
filename1 = filepath+'GroundTruth.txt';
filename2 = filepath+'CameraFrameNavStateTrajectory.txt';
NS = np.loadtxt(filename);
#NS1 = np.loadtxt(filename1, delimiter = ",");
...
ax.plot(NS2[:,1],NS2[:,2],NS2[:,3],'b',label=u'VIORB Trajectory');
