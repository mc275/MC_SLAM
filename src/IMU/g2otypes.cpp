...
namespace g2o 
{
	...
	Matrix3d J_pi_r0 = -Rcic0*SO3::hat(P0-tcb)*Rcb;		// -Rcb*RiT*SO3::hat(R0*RcbT*(p0-tcb))
...
// 	Matrix3d JrBiasGCorr = Sophus::SO3::JacobianR(J_rPhi_dbg*dBgi);
	...
	_jacobianOplusXi.block<3,3>(0,6) = Sophus::SO3::hat(RiT*(Pj-Pi-Vi*dTij-0.5*GravityVec*dT2));	// J_rP_Ri
