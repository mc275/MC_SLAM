...
namespace ORB_SLAM2
{
    ...
    */
    ...
    // 根据其他人实验建议数据
    double IMUData::_gyrBiasRw2 = 2.0e-5 * 2.0e-5/**10*/;        // 2e-12*2e3
    ...
    // IMU漂移方差
    Matrix3d IMUData::_gyrBiasRWCov =
            Matrix3d::Identity() * _gyrBiasRw2;                // sigma_gw * sigma_gw * dt, ~2e-12
    Matrix3d IMUData::_accBiasRWCov =
            Matrix3d::Identity() * _accBiasRw2;                // sigma_aw * sigma_aw * dt, ~4.5e-8
